<?php return array (
  ...
  array (
    'normal' => DOMPDF_FONT_DIR . 'Calibri Bold',
    'bold' => DOMPDF_FONT_DIR . 'Calibri Italic',
    'italic' => DOMPDF_FONT_DIR . 'Calibri Bold Italic',
    'bold_italic' => DOMPDF_FONT_DIR . 'Calibri Bold',
  ),
  '/users/cacho/desktop/aboisnlr.ttf' => 
  array (
    'normal' => DOMPDF_FONT_DIR . 'aboisblr',
    'bold' => DOMPDF_FONT_DIR . 'aboisblr',
    'italic' => DOMPDF_FONT_DIR . 'aboisblr',
    'bold_italic' => DOMPDF_FONT_DIR . 'aboisblr',
  ),
  'aboitiz sans' => 
  array (
    'normal' => DOMPDF_FONT_DIR . 'aboisnlr',
    'bold' => DOMPDF_FONT_DIR . 'aboisblr',
    'italic' => DOMPDF_FONT_DIR . 'aboisnlr',
    'bold_italic' => DOMPDF_FONT_DIR . 'aboisnlr',
  ),
  'calibri' => 
  array (
    'normal' => DOMPDF_FONT_DIR . 'Calibri',
    'bold' => DOMPDF_FONT_DIR . 'Calibri Bold',
    'italic' => DOMPDF_FONT_DIR . 'Calibri Italic',
    'bold_italic' => DOMPDF_FONT_DIR . 'Calibri Bold Italic',
  ),
) ?>