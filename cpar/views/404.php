<html lang="en">
	<head>
		...
		<!-- Theme style -->
		<link href="/_theme/css/theme-style.min.css" rel="stylesheet">
	...
	<body>
		<div id="content">
			...
			<div class="container">
				<div class="col-md-12">
					<div id="page_404_content">
						<h2 class="font-xs-x6 font-sm-x10 font-md-x10">Error 404</h2>
						<br/>
						<br/>
						<a id="back_button" href="/" class="btn btn-default btn-lg">
				          <i class="glyphicon glyphicon-home"></i>&nbsp;Back to Home
				        </a>
				        <br/>
						<br/>
				        <h2 class="font-xs-x1 font-sm-x1 font-md-x1">An error occured while processing your request</h2>
					</div>
				</div>
			</div>
		</div>
