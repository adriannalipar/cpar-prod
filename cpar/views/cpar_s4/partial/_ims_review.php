	...
	<div class="col-md-8">
		<div class="form_content">
			<fieldset>
				...
				<!-- Mark as Effective. Recommend to close the CPAR. -->
				<div class="form-group">
				  <div class="col-md-11 col-md-offset-1">
				    <input id="mark_as_effective" type="radio" name="review_action" value="<?php echo REVIEW_ACTIONS_S4_MARK_EFF; ?>"/> &nbsp; Mark as Effective. Recommend to close the CPAR.
				  </div>
				</div>

				<!-- Incomplete Information. Return to -->
				<div class="form-group pb-10">
				  <div class="col-md-11 col-md-offset-1">
				    <input id="push_back" type="radio" name="review_action" value="<?php echo REVIEW_ACTIONS_S4_PUSH_BACK; ?>"/> 
				    &nbsp; Incomplete information. Return to 
				  </div>
				</div>
				<div>
					...
					<div class="form-group">
					  ...
					  <div class="col-md-8">
					    <select id="pb_stage" name="pb_stage" class="form-control input-md">
					    	<option value="<?php echo CPAR_STAGE_2 . PUSH_BACK_SEPARATOR . CPAR_MINI_STATUS_S2_2A2; ?>">Stage 2 - For CA/PA</option>
					    	<option value="<?php echo CPAR_STAGE_3 . PUSH_BACK_SEPARATOR . CPAR_MINI_STATUS_S3_3B2; ?>">Stage 3 - For Follow Up Implementation</option>
					    </select>
					  </div>
					</div>
