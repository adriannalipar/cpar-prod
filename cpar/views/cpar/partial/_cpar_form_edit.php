		...
		<fieldset>
			...
			<div id="attachments_form_group" class="form-group">
			  ...
			  <div class="col-md-9">
			  	...
			  	<?php /*if(intval($cpar->status) == CPAR_STAGE_1 && (strcmp($cpar->sub_status, CPAR_MINI_STATUS_FOR_IMS_REVIEW)) != 0) {*//* ?>
				  	<br/>
...
<?php
	...
	if($cpar->status == CPAR_STAGE_1 && strcmp($cpar->sub_status, CPAR_MINI_STATUS_PUSHED_BACK) == 0) {
