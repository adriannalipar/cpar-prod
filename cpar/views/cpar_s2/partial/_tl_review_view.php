<legend class="red_legend">To be filled-in by Team Leader</legend>
...
<div class="row">
	<div class="col-md-8">
		<div class="form_content">
			<fieldset>
				<input disabled="disabled" type="hidden" name="is_tl_review" value="true" />
				...
				<div class="form-group">
				  <div class="col-md-9 col-md-offset-3">
				    <input disabled="disabled" id="mark_as_approved" type="radio" name="review_action" value="<?php echo REVIEW_ACTIONS_S2_MARK_APPR; ?>"/> &nbsp; Approved.
				  </div>
				</div>
				...
				<div class="form-group">
				  <div class="col-md-9 col-md-offset-3">
				    <input disabled="disabled" id="mark_inv" type="radio" name="review_action" value="<?php echo REVIEW_ACTIONS_S2_MARK_INV; ?>"/> &nbsp; Not Accepted. Return to Addressee for Corrections.
				  	<br/>
				...
				<div class="form-group">
				  ...
				  <div class="col-md-8">
				    <textarea disabled="disabled" id="tl_review_remarks" name="tl_review_remarks" class="form-control"></textarea>
				  </div>
				</div>
