    ...
    <form id="cpar_form" class="form-horizontal basic_form" enctype="multipart/form-data">
	    ...
	    <?php
			...
			<?php
				...
				$this->load->view('partials/action_plan', array('action_header' => $action_header, 'ap_required' => $ap_required));
			...
			<legend class="red_legend super_indented"><?php echo $action_header; ?> Action Plan <?php echo (strtolower($action_header) == 'preventive') ? ' <i>(Continual Improvement Action)</i>' : ''; ?> Details</legend>
			<div class="row">
				<div id="action_details_input_wrapper" class="col-md-11 col-md-offset-1">
					...
					<?php
						...
						$this->load->view('partials/task', array());
