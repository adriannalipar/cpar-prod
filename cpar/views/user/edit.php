...
<div id="content">
  <div class="container">
    ...
    <h2 class="no_top_margin title-divider"><span>Edit <span class="de-em">User</span></span></h2>
		      ...
		      <form id="user_form" class="form-horizontal">
					<fieldset>
						...
						<div class="form-group required">
						  ...
						  <input id="fname" name="fname" type="text" class="form-control input-md" value="<?php echo $user->first_name; ?>" />
						  </div>
						</div>
						...
						<div class="form-group">
						  ...
						  <div class="col-md-6">
						  <input id="mname" name="mname" type="text" class="form-control input-md" value="<?php echo $user->middle_name; ?>" />						    
						  </div>
						</div>
						...
						<div class="form-group required">
						  ...
						  <div class="col-md-6">
						  <input id="lname" name="lname" type="text" class="form-control input-md" value="<?php echo $user->last_name; ?>" />
						  </div>
						</div>
						...
						<div class="form-group required">
						  ...
						  <div class="col-md-6">
						  <input id="pos_title" name="pos_title" type="text" class="form-control input-md" value="<?php echo $user->position_title; ?>" />
						  </div>
						</div>
						  ...
						  <div class="col-md-6">
						    <select id="location" name="location" class="form-control">
						      ...
						      <?php foreach($locations as $loc): ?>
						      	<option <?php echo $loc['id'] == $user->location ? "selected='selected'" : ""; ?> value="<?php echo $loc['id']; ?>"><?php echo $loc['name']; ?></option>
						      <?php endforeach; ?>
						    </select>
						  </div>
						</div>
						  ...
						  <div class="col-md-6">
						    <select id="team" name="team" class="form-control">
						      ...
						      <?php foreach($teams as $team): ?>
						      	<option <?php echo $team['id'] == $user->team ? "selected='selected'" : ""; ?> value="<?php echo $team['id']; ?>"><?php echo $team['name']; ?></option>
						      <?php endforeach; ?>>
						    </select>
						  </div>
						</div>
						...
						<div class="form-group">
						  ...
						  <div class="col-md-6">
						  	<input id="team_lead" name="team_lead" class="form-control input-md" value='[{"id":"<?php echo $user->team_lead; ?>","text":"<?php echo $user->team_lead_name; ?>"}]' />
						  </div>
						</div>
					</fieldset>
					...
					<fieldset>
						...
						<div class="form-group required">
						  ...
						  <div class="col-md-6">
						  <input id="email" name="email" type="text" class="form-control input-md" value="<?php echo $user->email_address; ?>" />
						...
						<div class="form-group required">
						  ...
						  <div class="col-md-6">
						  	<select id="access_level" name="access_level" class="form-control">
						  		<option value="">Please select</option>
								<option <?php echo ACCESS_LEVEL_ADMIN_FLAG == $user->access_level ? "selected='selected'" : ""; ?> value="1">Administrator</option>
								<option <?php echo ACCESS_LEVEL_ADMIN_FLAG != $user->access_level ? "selected='selected'" : ""; ?> value="2">User</option>
						    </select>
						  </div>
						</div>
						...
						<div class="form-group required">
						  ...
						  <div class="col-md-6">
						    ...
						    <label class="radio-inline" for="user_status-1">
						      <input type="radio" name="user_status" id="user_status-1" value="1" <?php echo $isActive ? 'checked="checked"' : '' ?> />
						      Active
						    </label> 
						    <label class="radio-inline" for="user_status-0">
						      <input type="radio" name="user_status" id="user_status-0" value="0" <?php echo $isInactive ? 'checked="checked"' : '' ?> />
						      Inactive
						    </label>
						  </div>
						</div>
						...
						<div class="form-group">
						  ...
						  <div class="col-md-6">
						    ...
						    <label class="checkbox-inline" for="user_role-0">
						      <input type="checkbox" name="ims_flag" id="ims_flag" <?php echo $imsFlag ? 'checked="checked"' : '' ?> value="1" />
						      IMS User
						    </label>
						    <label class="checkbox-inline" for="user_role-1">
						      <input type="checkbox" name="mr_flag" id="mr_flag" <?php echo $mrFlag ? 'checked="checked"' : '' ?> value="1" <?php echo $mrFlag ? 'disabled' : ''; ?> />
