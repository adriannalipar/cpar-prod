				...
				public function do_multi_upload($field){
					...
					foreach ($_FILES[$field]["name"] as $i => $v) {
						...
						if(!is_uploaded_file($_FILES[$field]["tmp_name"][$i])){
							...
							switch($error){
								//UPLOAD_ERR_INI_SIZE
								case 1: error_log('upload_file_exceeds_limit');
									$this->set_error("upload_file_exceeds_limit");
								break;
								//UPLOAD_ERR_FORM_SIZE
								case 2: error_log('upload_file_exceeds_form_limit');
									$this->set_error("upload_file_exceeds_form_limit");
								break;
								//UPLOAD_ERR_PARTIAL
								case 3: error_log('upload_file_partial');
									$this->set_error("upload_file_partial");
								break;
								//UPLOAD_ERR_NO_FILE
								case 4: error_log('upload_no_file_selected');
									$this->set_error("upload_no_file_selected");
								break;
								//UPLOAD_ERR_NO_TMP_DIR
								case 6: error_log('upload_no_temp_directory');
									$this->set_error("upload_no_temp_directory");
								break;
								//UPLOAD_ERR_CANT_WRITE
								case 7: error_log('upload_unable_to_write_file');
									$this->set_error("upload_unable_to_write_file");
								break;
								//UPLOAD_ERR_EXTENSION
								case 8: error_log('upload_stopped_by_extension');
									$this->set_error("upload_stopped_by_extension");
								break;
								default: error_log('upload_no_file_selected');
									$this->set_error("upload_no_file_selected");
								break;
							}
						...
						if(!$this->is_allowed_filetype(TRUE)){ error_log('upload_invalid_filetype1');
						...
						if(!empty($this->_multi_file_name_override[$i])){
							...
							if(!$this->is_allowed_filetype(TRUE)){ error_log('upload_invalid_filetype2');
								$this->set_error("upload_invalid_filetype");
								return FALSE;
							}
						}
						...
						if(!$this->is_allowed_filesize()){ error_log('upload_invalid_filesize');
						...
						if(!$this->is_allowed_dimensions()){ error_log('upload_invalid_dimensions');
						 ...
						 */
							if($this->xss_clean){
								if($this->do_xss_clean() === FALSE){ error_log('upload_unable_to_write_file');
									$this->set_error("upload_unable_to_write_file");
									return FALSE;
								}
							}
						 ...
						 */
							if(!@copy($this->file_temp, $this->upload_path.$this->file_name)){
								if(!@move_uploaded_file($this->file_temp, $this->upload_path.$this->file_name)){ error_log('upload_destination_error');
